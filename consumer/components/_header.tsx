        ...
        return (
            <header css={headerCss} style={headerStyles}>
                <PageCentered className="centered">
                    <div css={css`height: ${h1FontSize + subFontSize}rem`}>
                        <h1 style={h1Styles}>Chandler Prall</h1>
                        <sup style={subStyles}>thoughts and experiments for the web</sup>
                    </div>
                    ...
                    <nav className="mediaLinks">
                        <a className="navlink" href="https://github.com/chandlerprall"><img style={mediaStyles} src="/images/media/github.svg"/></a>
                        <a className="navlink" href="https://twitter.com/chandlerprall"><img style={mediaStyles} src="/images/media/twitter.svg"/></a>
                    </nav>
                </PageCentered>
            </header>
        );
